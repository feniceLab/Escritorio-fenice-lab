const N={title:"Starkën Design System/Componentes/Cards",tags:["autodocs"],parameters:{docs:{description:{component:"Sistema de cards do Starkën Design System. KPI Cards, Metric Cards, Content Cards, Status Cards e Chart Cards — todos usados no dashboard Escritório Virtual."}}}},i=`
  background: #0f172a;
...
`,s={render:()=>`
  ...
  `},d={render:()=>`
    <div style="padding: 2rem;">
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(260px, 1fr)); gap: 1rem;">
        ...
        ${[{label:"Posts Publicados",value:"47",unit:"hoje",delta:"+12%",deltaPos:!0,icon:"📤",color:"#10b981",bg:"rgba(16,185,129,0.08)",status:"PUBLISHED"},{label:"Posts Agendados",value:"18",unit:"pendentes",delta:"-3 vs ontem",deltaPos:!1,icon:"🗓️",color:"#3b82f6",bg:"rgba(59,130,246,0.08)",status:"QUEUED"},{label:"Posts com Falha",value:"2",unit:"erros",delta:"necessita ação",deltaPos:!1,icon:"⚠️",color:"#ef4444",bg:"rgba(239,68,68,0.08)",status:"FAILED"},{label:"Taxa de Aprovação",value:"94",unit:"%",delta:"+2pp vs mês",deltaPos:!0,icon:"⭐",color:"#f59e0b",bg:"rgba(245,158,11,0.08)",status:"SCORE"}].map(({label:n,value:e,unit:t,delta:o,deltaPos:r,icon:a,color:c,bg:v,status:Q})=>`
          <div style="${i} position: relative; overflow: hidden;">
            <div style="position: absolute; top: 0; left: 0; right: 0; height: 2px; background: ${c};"></div>
            <div style="display: flex; align-items: flex-start; justify-content: space-between; margin-bottom: 1.25rem;">
              <div>
                <div style="color: #64748b; font-size: 0.75rem; text-transform: uppercase; letter-spacing: 0.08em; margin-bottom: 0.25rem;">${n}</div>
                <div style="display: flex; align-items: baseline; gap: 0.5rem;">
                  <span style="color: #ffffff; font-size: 2rem; font-weight: 800; letter-spacing: -0.02em;">${e}</span>
                  <span style="color: #64748b; font-size: 0.875rem;">${t}</span>
                </div>
              </div>
              <div style="
      ...
      <div style="max-width: 380px;">
        <div style="${i}">
          ...
          <div style="display: flex; align-items: center; gap: 2rem; margin-bottom: 1.5rem;">
            <div style="position: relative; width: 96px; height: 96px; flex-shrink: 0;">
              <svg width="96" height="96" viewBox="0 0 96 96" style="transform: rotate(-90deg);">
                ...
                <circle cx="48" cy="48" r="40" fill="none" stroke="#10b981" stroke-width="8"
                  ...
                  stroke-dashoffset="${Math.PI*2*40*(1-.94)}"
            ...
            <div style="flex: 1;">
              ${[{label:"Entregas no prazo",value:98,color:"#10b981"},{label:"Taxa de aprovação",value:94,color:"#10b981"},{label:"Posts sem falha",value:96,color:"#3b82f6"},{label:"Clientes ativos",value:86,color:"#f59e0b"}].map(({label:n,value:e,color:t})=>`
                <div style="margin-bottom: 0.6rem;">
                  <div style="display: flex; justify-content: space-between; margin-bottom: 0.2rem;">
                    <span style="color: #94a3b8; font-size: 0.7rem;">${n}</span>
                    <span style="color: ${t}; font-size: 0.7rem; font-weight: 700;">${e}%</span>
                  </div>
                  <div style="height: 3px; background: rgba(255,255,255,0.06); border-radius: 100px; overflow: hidden;">
                    <div style="height: 100%; width: ${e}%; background: ${t}; border-radius: 100px;"></div>
                  </div>
                </div>
              `).join("")}
            </div>
      ...
      <div style="max-width: 520px;">
        <div style="${i}">
          ...
          <div style="display: flex; flex-direction: column; gap: 0.75rem;">
            ${[{client:"Fenix Performance",platform:"IG",time:"14:00",type:"Feed",thumb:"./post-1.png",status:"QUEUED"},{client:"Alpha Assessoria",platform:"FB",time:"15:30",type:"Carrossel",thumb:null,status:"QUEUED"},{client:"Fenix Performance",platform:"IG+FB",time:"18:00",type:"Stories",thumb:"./post-3.png",status:"PROCESSING"},{client:"Cliente XYZ",platform:"FB",time:"20:00",type:"Feed",thumb:null,status:"QUEUED"}].map(({client:n,platform:e,time:t,type:o,thumb:r,status:a})=>`
              <div style="
                display: flex;
                align-items: center;
                gap: 1rem;
              ...
              ">
                ...
                <div style="
                  width: 40px; height: 40px;
                  border-radius: 8px;
                  background: ${r?"transparent":"#1e293b"};
                  overflow: hidden;
                  flex-shrink: 0;
                  display: flex; align-items: center; justify-content: center;
                  font-size: 1.25rem;
                ">
                  ${r?`<img src="${r}" style="width: 100%; height: 100%; object-fit: cover;" />`:"🖼️"}
                </div>

                <!-- Info -->
                <div style="flex: 1; min-width: 0;">
                  <div style="color: #ffffff; font-size: 0.8rem; font-weight: 600; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">${n}</div>
                  <div style="color: #64748b; font-size: 0.7rem;">${o} · ${e}</div>
                </div>

                <!-- Time -->
                <div style="text-align: right; flex-shrink: 0;">
                  <div style="color: #94a3b8; font-size: 0.8rem; font-weight: 600; font-family: 'Fira Code', monospace;">${t}</div>
                  <span style="
                    font-size: 0.65rem;
                    font-weight: 700;
                    padding: 0.1rem 0.4rem;
                    border-radius: 4px;
                    ${a==="PROCESSING"?"background: rgba(245,158,11,0.12); color: #fbbf24; border: 1px solid rgba(245,158,11,0.2);":"background: rgba(59,130,246,0.12); color: #60a5fa; border: 1px solid rgba(59,130,246,0.2);"}
                  ">${a}</span>
                </div>
              </div>
            `).join("")}
  ...
  `},f={render:()=>`
    <div style="padding: 2rem;">
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); gap: 1rem;">
        ...
        <!-- Task Card -->
        <div style="${i} cursor: pointer; transition: all 0.2s;">
        ...
        <!-- Overdue Card -->
        <div style="${i} border-color: rgba(239,68,68,0.25);">
        ...
        <div style="${i}">
          <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 1.5rem;">
            ...
            <div style="display: flex; gap: 0.5rem;">
              ${["7D","30D","90D"].map((n,e)=>`
                <button style="
                  background: ${e===0?"rgba(16,185,129,0.15)":"transparent"};
                  border: 1px solid ${e===0?"rgba(16,185,129,0.3)":"rgba(255,255,255,0.08)"};
                  color: ${e===0?"#10b981":"#64748b"};
                  font-size: 0.7rem;
                  font-weight: 600;
          ...
          <div style="display: flex; align-items: flex-end; gap: 0.5rem; height: 120px; margin-bottom: 0.75rem;">
            ${[14,22,18,31,25,28,47].map((n,e)=>`
              <div style="flex: 1; display: flex; flex-direction: column; align-items: center; gap: 0.25rem;">
                <div style="
                  width: 100%;
                  height: ${n/47*100}px;
                  background: ${e===6?"linear-gradient(180deg, #10b981, #0d9488)":"rgba(16,185,129,0.2)"};
          ...
          <div style="display: flex; gap: 0.5rem;">
            ${["Seg","Ter","Qua","Qui","Sex","Sáb","Dom"].map((n,e)=>`
              <div style="flex: 1; text-align: center; color: ${e===6?"#10b981":"#64748b"}; font-size: 0.65rem; font-weight: ${e===6?"700":"400"};">${n}</div>
            `).join("")}
          </div>
          ...
          <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 1rem; margin-top: 1.5rem; padding-top: 1.25rem; border-top: 1px solid rgba(255,255,255,0.06);">
            ${[{label:"Total semana",value:"185",color:"#10b981"},{label:"Média/dia",value:"26.4",color:"#3b82f6"},{label:"Melhor dia",value:"47",color:"#f59e0b"}].map(({label:n,value:e,color:t})=>`
              <div style="text-align: center;">
                <div style="color: ${t}; font-size: 1.25rem; font-weight: 800;">${e}</div>
                <div style="color: #64748b; font-size: 0.7rem;">${n}</div>
              </div>
            `).join("")}
          </div>
        </div>
  ...
  `},g={render:()=>`
    <div style="padding: 2rem;">
      ...
      <div style="display: flex; flex-direction: column; gap: 0.75rem; max-width: 560px;">
        ...
        ${[{type:"success",icon:"✅",color:"#10b981",bg:"rgba(16,185,129,0.06)",border:"rgba(16,185,129,0.2)",title:"Post publicado com sucesso",body:"Fenix Performance · Instagram Feed · Publicado às 14:03"},{type:"warning",icon:"⚠️",color:"#f59e0b",bg:"rgba(245,158,11,0.06)",border:"rgba(245,158,11,0.2)",title:"Post em fila há mais de 5 minutos",body:"Alpha Assessoria · Facebook · Na fila desde 13:45 — verifique o processador"},{type:"error",icon:"🚨",color:"#ef4444",bg:"rgba(239,68,68,0.06)",border:"rgba(239,68,68,0.2)",title:"Falha na publicação — ação necessária",body:'Fenix Performance · IG Stories · Erro: "Media upload failed". Tente novamente.'},{type:"info",icon:"ℹ️",color:"#3b82f6",bg:"rgba(59,130,246,0.06)",border:"rgba(59,130,246,0.2)",title:"Relatório mensal disponível",body:"O relatório de Abril 2026 foi gerado por João e está pronto para revisão."}].map(({icon:n,color:e,bg:t,border:o,title:r,body:a})=>`
          <div style="
            background: ${t};
            border: 1px solid ${o};
            border-radius: 12px;
            ...
            gap: 0.875rem;
          ">
            <span style="font-size: 1.25rem; flex-shrink: 0; margin-top: 0.1rem;">${n}</span>
            <div style="flex: 1;">
              <div style="color: #ffffff; font-size: 0.875rem; font-weight: 600; margin-bottom: 0.2rem;">${r}</div>
              <div style="color: #94a3b8; font-size: 0.8rem; line-height: 1.5;">${a}</div>
            </div>
            <button style="
  ...
  `},b={render:()=>`
    <div style="padding: 2rem; background: #020617; min-height: 100vh; font-family: 'Inter', sans-serif;">
      ...
      <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 1rem; margin-bottom: 1.5rem;">
        ${[{label:"Clientes Fenix",value:"26",delta:"+4",icon:"🏢",color:"#10b981",pct:72},{label:"Clientes Alpha",value:"10",delta:"+2",icon:"🔵",color:"#3b82f6",pct:50},{label:"Pendentes",value:"36",delta:"urgente",icon:"⏳",color:"#f59e0b",pct:85},{label:"Enviados",value:"142",delta:"+18",icon:"✅",color:"#10b981",pct:89}].map(({label:n,value:e,delta:t,icon:o,color:r,pct:a})=>`
          <div style="${i}">
            <div style="display: flex; justify-content: space-between; margin-bottom: 0.75rem;">
              <span style="font-size: 1.5rem;">${o}</span>
              <span style="color: ${r}; font-size: 0.7rem; font-weight: 700;">${t}</span>
            </div>
            <div style="color: #ffffff; font-size: 1.875rem; font-weight: 800; letter-spacing: -0.02em;">${e}</div>
            <div style="color: #94a3b8; font-size: 0.75rem; margin-bottom: 0.75rem;">${n}</div>
            <div style="height: 3px; background: rgba(255,255,255,0.06); border-radius: 100px; overflow: hidden;">
              <div style="height: 100%; width: ${a}%; background: ${r}; border-radius: 100px;"></div>
            </div>
          </div>
        `).join("")}
      </div>
      ...
      <div style="display: grid; grid-template-columns: 1fr 340px; gap: 1rem;">
        ...
        <div style="${i}">
          ...
          <div style="display: flex; align-items: flex-end; gap: 0.5rem; height: 100px;">
            ${[14,22,18,31,25,28,47].map((n,e)=>`
              <div style="flex: 1; height: ${n/47*100}%; background: ${e===6?"linear-gradient(180deg, #10b981, #0d9488)":"rgba(16,185,129,0.2)"}; border-radius: 4px 4px 0 0;"></div>
            `).join("")}
          </div>
          <div style="display: flex; margin-top: 0.5rem;">
            ${["Seg","Ter","Qua","Qui","Sex","Sáb","Dom"].map((n,e)=>`<div style="flex: 1; text-align: center; color: ${e===6?"#10b981":"#64748b"}; font-size: 0.65rem;">${n}</div>`).join("")}
          </div>
        </div>
        ...
        <div style="${i}">
          ...
          <div style="display: flex; flex-direction: column; gap: 0.5rem;">
            ${[{client:"Fenix Perf.",platform:"IG",time:"14:00",status:"QUEUED"},{client:"Alpha Assessoria",platform:"FB",time:"15:30",status:"QUEUED"},{client:"Fenix Perf.",platform:"IG+FB",time:"18:00",status:"PROCESSING"}].map(({client:n,platform:e,time:t,status:o})=>`
              <div style="display: flex; align-items: center; justify-content: space-between; padding: 0.6rem 0.75rem; background: rgba(255,255,255,0.03); border-radius: 8px; border: 1px solid rgba(255,255,255,0.05);">
                <div>
                  <div style="color: #ffffff; font-size: 0.75rem; font-weight: 600;">${n}</div>
                  <div style="color: #64748b; font-size: 0.65rem;">${e}</div>
                </div>
                <div style="text-align: right;">
                  <div style="color: #94a3b8; font-size: 0.75rem; font-family: monospace;">${t}</div>
                  <span style="
                    font-size: 0.6rem; font-weight: 700;
                    padding: 0.1rem 0.35rem; border-radius: 3px;
                    ${o==="PROCESSING"?"background: rgba(245,158,11,0.15); color: #fbbf24;":"background: rgba(59,130,246,0.15); color: #60a5fa;"}
                  ">${o}</span>
                </div>
              </div>
            `).join("")}
  ...
  `};var y,u,x;s.parameters={...s.parameters,docs:{...(y=s.parameters)==null?void 0:y.docs,source:{originalSource:`{
  render: () => \`
    <div style="padding: 2rem;">
      <h1 style="color: #10b981; font-size: 1.5rem; margin-bottom: 0.5rem;">KPI Cards</h1>
      <p style="color: #94a3b8; font-size: 0.875rem; margin-bottom: 2rem;">Cards de métricas chave — usados no topo do dashboard Executive Performance.</p>
  ...
  \`
}`,...(x=(u=s.parameters)==null?void 0:u.docs)==null?void 0:x.source}}};var h,w,z;d.parameters={...d.parameters,docs:{...(h=d.parameters)==null?void 0:h.docs,source:{originalSource:`{
  render: () => \`
    <div style="padding: 2rem;">
      <h1 style="color: #10b981; font-size: 1.5rem; margin-bottom: 0.5rem;">Metric Cards — Variantes de Status</h1>
      <p style="color: #94a3b8; font-size: 0.875rem; margin-bottom: 2rem;">Cards de métrica com indicador de status. Use para relatórios detalhados e painéis de acompanhamento.</p>
  ...
  \`
}`,...(z=(w=d.parameters)==null?void 0:w.docs)==null?void 0:z.source}}};var $,k,C;l.parameters={...l.parameters,docs:{...($=l.parameters)==null?void 0:$.docs,source:{originalSource:`{
  render: () => \`
    <div style="padding: 2rem;">
      <h1 style="color: #10b981; font-size: 1.5rem; margin-bottom: 2rem;">Score Operacional Card</h1>
  ...
  \`
}`,...(C=(k=l.parameters)==null?void 0:k.docs)==null?void 0:C.source}}};var E,P,S;m.parameters={...m.parameters,docs:{...(E=m.parameters)==null?void 0:E.docs,source:{originalSource:`{
  render: () => \`
    <div style="padding: 2rem;">
      <h1 style="color: #10b981; font-size: 1.5rem; margin-bottom: 2rem;">Próximos Posts Agendados</h1>
              ...
              ">
                ...
                <div style="text-align: right; flex-shrink: 0;">
                  ...
                  <span style="
                    ...
                    padding: 0.1rem 0.4rem;
                    border-radius: 4px;
                    \${status === 'PROCESSING' ? 'background: rgba(245,158,11,0.12); color: #fbbf24; border: 1px solid rgba(245,158,11,0.2);' : 'background: rgba(59,130,246,0.12); color: #60a5fa; border: 1px solid rgba(59,130,246,0.2);'}
                  ">\${status}</span>
                </div>
              </div>
            \`).join('')}
  ...
  \`
}`,...(S=(P=m.parameters)==null?void 0:P.docs)==null?void 0:S.source}}};var j,D,A;f.parameters={...f.parameters,docs:{...(j=f.parameters)==null?void 0:j.docs,source:{originalSource:`{
  render: () => \`
    <div style="padding: 2rem;">
      <h1 style="color: #10b981; font-size: 1.5rem; margin-bottom: 2rem;">Content Cards</h1>
      <p style="color: #94a3b8; font-size: 0.875rem; margin-bottom: 1.5rem;">Usados no gerenciamento de conteúdo para representar tarefas e grupos.</p>
  ...
  \`
}`,...(A=(D=f.parameters)==null?void 0:D.docs)==null?void 0:A.source}}};var F,I,B;p.parameters={...p.parameters,docs:{...(F=p.parameters)==null?void 0:F.docs,source:{originalSource:`{
  render: () => \`
    <div style="padding: 2rem;">
      <h1 style="color: #10b981; font-size: 1.5rem; margin-bottom: 2rem;">Chart Cards</h1>
  ...
  \`
}`,...(B=(I=p.parameters)==null?void 0:I.docs)==null?void 0:B.source}}};var U,T,M;g.parameters={...g.parameters,docs:{...(U=g.parameters)==null?void 0:U.docs,source:{originalSource:`{
  render: () => \`
    <div style="padding: 2rem;">
      <h1 style="color: #10b981; font-size: 1.5rem; margin-bottom: 2rem;">Alert Cards — Notificações e Status</h1>
  ...
  \`
}`,...(M=(T=g.parameters)==null?void 0:T.docs)==null?void 0:M.source}}};var O,G,R;b.parameters={...b.parameters,docs:{...(O=b.parameters)==null?void 0:O.docs,source:{originalSource:`{
  render: () => \`
    <div style="padding: 2rem; background: #020617; min-height: 100vh; font-family: 'Inter', sans-serif;">
  ...
  \`
}`,...(R=(G=b.parameters)==null?void 0:G.docs)==null?void 0:R.source}}};const V=["KpiCards","MetricCards","ScoreOperacionalCard","ProximosPostsCard","ContentCard","ChartCard","AlertCards","DashboardPreview"];export{g as AlertCards,p as ChartCard,f as ContentCard,b as DashboardPreview,s as KpiCards,d as MetricCards,m as ProximosPostsCard,l as ScoreOperacionalCard,V as __namedExportsOrder,N as default};
