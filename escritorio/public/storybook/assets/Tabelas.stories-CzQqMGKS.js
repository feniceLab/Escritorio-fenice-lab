const c={title:"Starkën Design System/Padrões/Tabelas",parameters:{docs:{description:{component:"Padrões de tabela usados no Escritório Virtual. Histórico de publicações, filas, relatórios de performance."}}}},o={render:()=>`
          ...
          <table style="width: 100%; border-collapse: collapse; min-width: 700px;">
            <thead>
              <tr style="border-bottom: 1px solid rgba(255,255,255,0.06);">
                ...
                ${["Cliente","Plataforma","Tipo","Data/Hora","Status","Ações"].map((e,r)=>`
                  <th style="
                    color: #64748b; font-size: 0.7rem; font-weight: 600;
                    text-transform: uppercase; letter-spacing: 0.08em;
                    padding: 0.75rem 1rem; text-align: left;
                    cursor: ${r<5?"pointer":"default"};
                  ">${e}${r<5?" ↕":""}</th>
                `).join("")}
              </tr>
            </thead>
            <tbody>
              ${[{client:"Fenix Performance",platform:"IG",type:"Feed",date:"18/04 14:03",status:"PUBLISHED",statusColor:"#10b981",selected:!1},{client:"Fenix Performance",platform:"FB",type:"Carrossel",date:"18/04 14:03",status:"PUBLISHED",statusColor:"#10b981",selected:!1},{client:"Alpha Assessoria",platform:"IG+FB",type:"Stories",date:"18/04 15:30",status:"QUEUED",statusColor:"#3b82f6",selected:!0},{client:"Alpha Assessoria",platform:"IG",type:"Reels",date:"18/04 18:00",status:"PROCESSING",statusColor:"#f59e0b",selected:!1},{client:"Fenix Performance",platform:"FB",type:"Feed",date:"17/04 09:00",status:"FAILED",statusColor:"#ef4444",selected:!1}].map(({client:e,platform:r,type:m,date:f,status:g,statusColor:t,selected:a})=>`
                <tr style="
                  border-bottom: 1px solid rgba(255,255,255,0.04);
                  background: ${a?"rgba(16,185,129,0.04)":"transparent"};
                  transition: background 0.15s;
                ">
                  <td style="padding: 0.875rem 1rem;">
                    <div style="
                      width: 16px; height: 16px; border-radius: 4px; cursor: pointer;
                      ${a?"background: #10b981; border: 2px solid #10b981; display: flex; align-items: center; justify-content: center;":"border: 2px solid rgba(255,255,255,0.15);"}
                    ">${a?'<span style="color: #020617; font-size: 0.6rem; font-weight: 900;">✓</span>':""}</div>
                  </td>
                  ...
                  <td style="padding: 0.875rem 1rem; color: #94a3b8; font-size: 0.8rem;">${m}</td>
                  <td style="padding: 0.875rem 1rem; color: #64748b; font-size: 0.8rem; font-family: 'Fira Code', monospace;">${f}</td>
                  <td style="padding: 0.875rem 1rem;">
                    <span style="
          ...
          <div style="display: flex; gap: 0.35rem;">
            ${["←","1","2","3","...","29","→"].map((e,r)=>`
              <button style="
                ...
                background: ${e==="1"?"rgba(16,185,129,0.12)":"rgba(255,255,255,0.04)"};
                border: 1px solid ${e==="1"?"rgba(16,185,129,0.3)":"rgba(255,255,255,0.08)"};
                color: ${e==="1"?"#10b981":"#94a3b8"};
                font-size: 0.75rem; font-weight: ${e==="1"?700:400};
  ...
  `};var s,i,d;o.parameters={...o.parameters,docs:{...(s=o.parameters)==null?void 0:s.docs,source:{originalSource:`{
  render: () => \`
    <div style="padding: 2rem; font-family: 'Inter', sans-serif;">
      <h1 style="color: #10b981; font-size: 1.5rem; margin-bottom: 0.5rem;">Tabela de Publicações</h1>
      <p style="color: #94a3b8; font-size: 0.875rem; margin-bottom: 2rem;">Baseada em publish_history — usada no histórico e relatórios.</p>
    ...
    selected
                ...
                ">
                  <td style="padding: 0.875rem 1rem;">
                    <div style="
                      width: 16px; height: 16px; border-radius: 4px; cursor: pointer;
                      \${selected ? 'background: #10b981; border: 2px solid #10b981; display: flex; align-items: center; justify-content: center;' : 'border: 2px solid rgba(255,255,255,0.15);'}
  ...
  \`
}`,...(d=(i=o.parameters)==null?void 0:i.docs)==null?void 0:d.source}}};var l,p,b;n.parameters={...n.parameters,docs:{...(l=n.parameters)==null?void 0:l.docs,source:{originalSource:`{
  render: () => \`
    <div style="padding: 2rem; font-family: 'Inter', sans-serif; max-width: 700px;">
      <h1 style="color: #10b981; font-size: 1.5rem; margin-bottom: 2rem;">Empty State — Tabela Vazia</h1>
  ...
  \`
}`,...(b=(p=n.parameters)==null?void 0:p.docs)==null?void 0:b.source}}};const u=["TabelaPublicacoes","TabelaVazia"];export{o as TabelaPublicacoes,n as TabelaVazia,u as __namedExportsOrder,c as default};
