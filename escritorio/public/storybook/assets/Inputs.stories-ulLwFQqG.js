const k={title:"Starkën Design System/Componentes/Inputs & Formulários",tags:["autodocs"],parameters:{docs:{description:{component:"Campos de formulário, selects, checkboxes, toggles e outros controles de entrada de dados. Base visual do Escritório Virtual."}}}},o=`
  width: 100%;
  background: #0f172a;
...
`,i={render:()=>`
      ...
      <div style="display: flex; flex-direction: column; gap: 1.5rem;">
        ...
        <div>
          ...
          <input
            ...
            style="${o} border-color: #10b981; box-shadow: 0 0 0 3px rgba(16,185,129,0.12);"
          />
        ...
        <div>
          ...
          <input
            ...
            style="${o} border-color: rgba(255,255,255,0.2);"
          />
        ...
        <div>
          ...
          <input
            type="text"
            value="EAAInvalid..."
            style="${o} border-color: #ef4444; box-shadow: 0 0 0 3px rgba(239,68,68,0.1);"
          />
        ...
        <div>
          ...
          <input
            ...
            style="${o} border-color: #10b981; padding-right: 2.5rem;"
          />
        ...
        <div>
          ...
          <input
            ...
            disabled
            style="${o} border-color: rgba(255,255,255,0.06); color: #475569; background: rgba(255,255,255,0.02); cursor: not-allowed;"
          />
        ...
        <div>
          ...
          <textarea
            style="${o} height: 100px; resize: vertical; line-height: 1.6;"
    ...
    <div style="padding: 2rem; font-family: 'Inter', sans-serif; max-width: 560px;">
      ...
      <div style="display: flex; flex-direction: column; gap: 1.5rem;">
        ...
        <div>
          ...
          <div style="position: relative;">
            <select style="${o} appearance: none; cursor: pointer; padding-right: 2.5rem; border-color: rgba(59,130,246,0.4);">
        ...
        <div>
          ...
          ">
            ${["Juan","Henrique"].map(t=>`
              ...
              ">
                <span style="width: 18px; height: 18px; border-radius: 50%; background: linear-gradient(135deg, #10b981, #0d9488); display: flex; align-items: center; justify-content: center; color: #fff; font-size: 0.6rem; font-weight: 700;">${t[0]}</span>
                ${t}
      ...
      <div style="display: flex; flex-direction: column; gap: 2.5rem;">
        ...
        <div>
          ...
          <div style="display: flex; flex-direction: column; gap: 0.75rem;">
            ${[{label:"Publicar no Instagram",checked:!0},{label:"Publicar no Facebook",checked:!0},{label:"Salvar no histórico",checked:!1},{label:"Enviar notificação ao cliente",checked:!1,disabled:!0}].map(({label:t,checked:n,disabled:e})=>`
              <label style="display: flex; align-items: center; gap: 0.75rem; cursor: ${e?"not-allowed":"pointer"}; opacity: ${e?.4:1};">
                <div style="
                  width: 18px; height: 18px; border-radius: 5px; flex-shrink: 0;
                  ${n?"background: #10b981; border: 2px solid #10b981; display: flex; align-items: center; justify-content: center;":"background: transparent; border: 2px solid rgba(255,255,255,0.2);"}
                ">${n?'<span style="color: #020617; font-size: 0.7rem; font-weight: 900; line-height: 1;">✓</span>':""}</div>
                <span style="color: ${e?"#475569":n?"#ffffff":"#94a3b8"}; font-size: 0.875rem;">${t}</span>
              </label>
            `).join("")}
          </div>
        </div>
        ...
        <div>
          ...
          <div style="display: flex; flex-direction: column; gap: 0.75rem;">
            ${[{label:"Publicar agora",desc:"Publica imediatamente",selected:!1},{label:"Agendar publicação",desc:"Escolha data e horário",selected:!0},{label:"Salvar como rascunho",desc:"Não publica ainda",selected:!1}].map(({label:t,desc:n,selected:e})=>`
              <label style="
                display: flex; align-items: flex-start; gap: 0.875rem;
                padding: 0.875rem 1rem;
                background: ${e?"rgba(16,185,129,0.06)":"rgba(255,255,255,0.02)"};
                border: 1px solid ${e?"rgba(16,185,129,0.25)":"rgba(255,255,255,0.06)"};
                border-radius: 10px; cursor: pointer;
              ">
                <div style="
                  width: 18px; height: 18px; border-radius: 50%; flex-shrink: 0; margin-top: 2px;
                  ${e?"border: 5px solid #10b981; background: #020617;":"border: 2px solid rgba(255,255,255,0.2); background: transparent;"}
                "></div>
                <div>
                  <div style="color: #ffffff; font-size: 0.875rem; font-weight: 500;">${t}</div>
                  <div style="color: #64748b; font-size: 0.75rem;">${n}</div>
                </div>
              </label>
            `).join("")}
          </div>
        ...
        <div>
          ...
          <div style="display: flex; flex-direction: column; gap: 1rem;">
            ${[{label:"Notificações ativas",desc:"Receber alertas de publicação",on:!0},{label:"Modo escuro",desc:"Interface em tema escuro",on:!0},{label:"Auto-publicar",desc:"Publicar automaticamente na fila",on:!1},{label:"Modo manutenção",desc:"Pausar todas as publicações",on:!1,danger:!0}].map(({label:t,desc:n,on:e,danger:r})=>`
              <div style="display: flex; align-items: center; justify-content: space-between; gap: 1rem;">
                ...
                <div style="
                  ...
                  background: ${e?r?"#ef4444":"#10b981":"rgba(255,255,255,0.1)"};
      ...
      <div style="background: #0f172a; border-radius: 16px; padding: 2rem; border: 1px solid rgba(255,255,255,0.08);">
        ...
        <div style="display: flex; flex-direction: column; gap: 1.25rem;">
          ...
          <div>
            ...
            <div style="position: relative;">
              <select style="${o} appearance: none; padding-right: 2.5rem; cursor: pointer;">
          ...
          <div>
            ...
            <div style="display: flex; gap: 0.75rem;">
              ${[{icon:"📸",label:"Instagram",active:!0,color:"#e1306c"},{icon:"📘",label:"Facebook",active:!0,color:"#1877f2"},{icon:"🎵",label:"TikTok",active:!1,color:"#010101"}].map(({icon:t,label:n,active:e,color:r})=>`
                <label style="
                  flex: 1; padding: 0.75rem;
                  background: ${e?r+"18":"rgba(255,255,255,0.03)"};
                  border: 1px solid ${e?r+"50":"rgba(255,255,255,0.06)"};
                  border-radius: 10px; cursor: pointer; text-align: center;
                ">
                  <div style="font-size: 1.25rem; margin-bottom: 0.25rem;">${t}</div>
                  <div style="color: ${e?"#ffffff":"#64748b"}; font-size: 0.75rem; font-weight: ${e?600:400};">${n}</div>
                </label>
              `).join("")}
            </div>
          </div>
          ...
          <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
            ...
            <div>
              ...
              <input type="text" value="18/04/2026 14:00" style="${o} border-color: rgba(16,185,129,0.4);" />
            </div>
          </div>
          ...
          <div>
            ...
            <textarea style="${o} height: 80px; resize: vertical; line-height: 1.6;" placeholder="Escreva o copy aqui...">Transforme seus resultados com a Starkën! ✨ #MarketingDigital #Resultados</textarea>
  ...
  `};var d,p,m;i.parameters={...i.parameters,docs:{...(d=i.parameters)==null?void 0:d.docs,source:{originalSource:`{
  render: () => \`
    <div style="padding: 2rem; font-family: 'Inter', sans-serif; max-width: 560px;">
      <h1 style="color: #10b981; font-size: 1.5rem; margin-bottom: 2.5rem;">Campos de Texto</h1>
  ...
  \`
}`,...(m=(p=i.parameters)==null?void 0:p.docs)==null?void 0:m.source}}};var c,b,f;a.parameters={...a.parameters,docs:{...(c=a.parameters)==null?void 0:c.docs,source:{originalSource:`{
  render: () => \`
    <div style="padding: 2rem; font-family: 'Inter', sans-serif; max-width: 560px;">
      <h1 style="color: #10b981; font-size: 1.5rem; margin-bottom: 2.5rem;">Selects & Dropdowns</h1>
  ...
  \`
}`,...(f=(b=a.parameters)==null?void 0:b.docs)==null?void 0:f.source}}};var g,u,v;l.parameters={...l.parameters,docs:{...(g=l.parameters)==null?void 0:g.docs,source:{originalSource:`{
  render: () => \`
    <div style="padding: 2rem; font-family: 'Inter', sans-serif; max-width: 560px;">
      <h1 style="color: #10b981; font-size: 1.5rem; margin-bottom: 2.5rem;">Checkboxes, Radios & Toggles</h1>
    ...
    disabled
              ...
              <label style="display: flex; align-items: center; gap: 0.75rem; cursor: \${disabled ? 'not-allowed' : 'pointer'}; opacity: \${disabled ? 0.4 : 1};">
                <div style="
                  width: 18px; height: 18px; border-radius: 5px; flex-shrink: 0;
                  \${checked ? 'background: #10b981; border: 2px solid #10b981; display: flex; align-items: center; justify-content: center;' : 'background: transparent; border: 2px solid rgba(255,255,255,0.2);'}
    ...
    selected
              ...
              ">
                <div style="
                  width: 18px; height: 18px; border-radius: 50%; flex-shrink: 0; margin-top: 2px;
                  \${selected ? 'border: 5px solid #10b981; background: #020617;' : 'border: 2px solid rgba(255,255,255,0.2); background: transparent;'}
                "></div>
                <div>
    ...
    desc: 'Receber alertas de publicação',
    on: true
  }, {
    label: 'Modo escuro',
    desc: 'Interface em tema escuro',
    on: true
  }, {
    label: 'Auto-publicar',
    desc: 'Publicar automaticamente na fila',
    on: false
  }, {
    label: 'Modo manutenção',
    desc: 'Pausar todas as publicações',
    on: false,
    danger: true
  }].map(({
    label,
  ...
  \`
}`,...(v=(u=l.parameters)==null?void 0:u.docs)==null?void 0:v.source}}};var y,x,h;s.parameters={...s.parameters,docs:{...(y=s.parameters)==null?void 0:y.docs,source:{originalSource:`{
  render: () => \`
    <div style="padding: 2rem; font-family: 'Inter', sans-serif; max-width: 600px;">
      <h1 style="color: #10b981; font-size: 1.5rem; margin-bottom: 0.5rem;">Formulário Completo</h1>
      <p style="color: #94a3b8; font-size: 0.875rem; margin-bottom: 2rem;">Exemplo real: formulário de agendamento de post.</p>
  ...
  \`
}`,...(h=(x=s.parameters)==null?void 0:x.docs)==null?void 0:h.source}}};const z=["CamposDeTexto","SelectsEDropdowns","CheckboxesEToggles","FormCompleto"];export{i as CamposDeTexto,l as CheckboxesEToggles,s as FormCompleto,a as SelectsEDropdowns,z as __namedExportsOrder,k as default};
