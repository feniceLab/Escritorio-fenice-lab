const S={title:"Starkën Design System/Fundamentos/Tipografia",parameters:{docs:{description:{component:"Sistema tipográfico completo do Starkën Design System. Fontes, escalas, pesos e uso correto em cada contexto."}}}},n={render:()=>`
    <div style="padding: 2rem; font-family: 'Inter', sans-serif;">
      ...
      ${[{token:"text-xs",size:"0.75rem",px:"12px",weight:"400",usage:"Labels, captions, micro-texto"},{token:"text-sm",size:"0.875rem",px:"14px",weight:"400",usage:"Texto auxiliar, metadados, placeholders"},{token:"text-base",size:"1rem",px:"16px",weight:"400",usage:"Corpo padrão, parágrafos"},{token:"text-lg",size:"1.125rem",px:"18px",weight:"500",usage:"Subtítulos, leads"},{token:"text-xl",size:"1.25rem",px:"20px",weight:"600",usage:"Títulos de seção pequenos"},{token:"text-2xl",size:"1.5rem",px:"24px",weight:"700",usage:"Títulos de card, heading h3"},{token:"text-3xl",size:"1.875rem",px:"30px",weight:"700",usage:"Títulos de página h2"},{token:"text-4xl",size:"2.25rem",px:"36px",weight:"800",usage:"Hero, heading h1"},{token:"text-5xl",size:"3rem",px:"48px",weight:"900",usage:"Display, headlines grandes"},{token:"text-6xl",size:"3.75rem",px:"60px",weight:"900",usage:"Números KPI, métricas destaque"}].map(({token:o,size:e,px:r,weight:t,usage:k})=>`
        <div style="
          display: grid;
        ...
        ">
          <div>
            <code style="color: #6ee7b7; font-size: 0.75rem; background: rgba(16,185,129,0.08); padding: 0.2rem 0.5rem; border-radius: 4px;">${o}</code>
            <div style="color: #64748b; font-size: 0.75rem; margin-top: 0.25rem;">${r} · w${t}</div>
          </div>
          <div style="color: #ffffff; font-size: ${e}; font-weight: ${t}; line-height: 1.2; letter-spacing: ${parseFloat(e)>=2?"-0.02em":"0"};">
            Starkën Design System
          </div>
          <div style="color: #64748b; font-size: 0.75rem; line-height: 1.4;">${k}</div>
        </div>
      `).join("")}
    </div>
  `},i={render:()=>`
    <div style="padding: 2rem;">
      ...
      <div style="background: #0f172a; border-radius: 16px; padding: 2rem; margin-bottom: 1.5rem; border: 1px solid rgba(255,255,255,0.08);">
        ...
        <div style="display: flex; gap: 1rem; flex-wrap: wrap;">
          ${["100 Thin","300 Light","400 Regular","500 Medium","600 SemiBold","700 Bold","800 ExtraBold","900 Black"].map(o=>{const[e,r]=o.split(" ");return`<span style="font-family: 'Inter', sans-serif; font-weight: ${e}; color: #94a3b8; font-size: 0.875rem;">${r} (${e})</span>`}).join("")}
        </div>
...
// ✓ 47 posts published today</pre>
  ...
  `},s={render:()=>`
    <div style="padding: 2rem;">
      ...
      <div style="display: grid; gap: 0.5rem; max-width: 700px;">
        ${[{weight:100,label:"Thin",use:"Decorativo apenas — nunca em corpo"},{weight:300,label:"Light",use:"Subtextos longos, legendas de gráfico"},{weight:400,label:"Regular",use:"Corpo de texto padrão"},{weight:500,label:"Medium",use:"Destaques no corpo, labels de formulário"},{weight:600,label:"SemiBold",use:"Títulos de card, navegação ativa"},{weight:700,label:"Bold",use:"Headings h2-h3, KPIs"},{weight:800,label:"ExtraBold",use:"Títulos de página h1, CTAs"},{weight:900,label:"Black",use:"Display headlines, números mega"}].map(({weight:o,label:e,use:r})=>`
          <div style="
            display: grid;
          ...
          ">
            <code style="color: #6ee7b7; font-size: 0.75rem;">${o}</code>
            <span style="color: #ffffff; font-size: 1.25rem; font-weight: ${o}; font-family: 'Inter', sans-serif;">${e} — Inter</span>
            <span style="color: #64748b; font-size: 0.8rem;">${r}</span>
          </div>
        `).join("")}
      </div>
    </div>
    ...
    <div style="padding: 2rem; max-width: 800px;">
      ...
      <div style="margin-top: 2rem; background: #0f172a; border-radius: 16px; padding: 2rem; border: 1px solid rgba(255,255,255,0.08);">
        ...
        <div style="display: grid; gap: 0.75rem;">
          ${[{el:"h1 → subtítulo",space:"8px (0.5rem)"},{el:"h1 → primeiro parágrafo",space:"24px (1.5rem)"},{el:"h2 → conteúdo",space:"20px (1.25rem)"},{el:"h3 → conteúdo",space:"16px (1rem)"},{el:"Entre parágrafos",space:"16px (1rem)"},{el:"Seção → próxima seção",space:"48px (3rem)"}].map(({el:o,space:e})=>`
            <div style="display: flex; justify-content: space-between; align-items: center; padding: 0.75rem 1rem; background: #020617; border-radius: 8px;">
              <span style="color: #e2e8f0; font-size: 0.875rem;">${o}</span>
              <code style="color: #6ee7b7; font-size: 0.8rem;">${e}</code>
            </div>
          `).join("")}
        </div>
      </div>
  ...
  `},d={render:()=>`
    <div style="padding: 2rem;">
      ...
      <div style="display: grid; gap: 1rem; max-width: 700px;">
        ${[{name:"Primary",color:"#ffffff",hex:"#ffffff",desc:"Headings, labels importantes, texto de destaque"},{name:"Secondary",color:"#94a3b8",hex:"#94a3b8",desc:"Corpo de texto, descrições, parágrafos"},{name:"Muted",color:"#64748b",hex:"#64748b",desc:"Metadados, timestamps, texto de suporte"},{name:"Disabled",color:"#475569",hex:"#475569",desc:"Texto de campo desabilitado"},{name:"Emerald",color:"#10b981",hex:"#10b981",desc:"Links, código inline, valores positivos"},{name:"Success",color:"#34d399",hex:"#34d399",desc:"Confirmações, status PUBLISHED"},{name:"Warning",color:"#fbbf24",hex:"#fbbf24",desc:"Avisos, status QUEUED/PROCESSING"},{name:"Error",color:"#f87171",hex:"#f87171",desc:"Erros, status FAILED"}].map(({name:o,color:e,hex:r,desc:t})=>`
          <div style="
            display: grid;
            ...
            border: 1px solid rgba(255,255,255,0.06);
          ">
            <div style="width: 32px; height: 32px; border-radius: 50%; background: ${e}; border: 2px solid rgba(255,255,255,0.15);"></div>
            <div>
              <div style="color: #ffffff; font-weight: 600; font-size: 0.875rem;">${o}</div>
              <code style="color: #6ee7b7; font-size: 0.75rem;">${r}</code>
            </div>
            <div style="color: ${e}; font-size: 0.875rem;">${t}</div>
          </div>
        `).join("")}
      </div>
    </div>
  ...
  render: () => \`
    ...
    px: '12px',
    weight: '400',
    usage: 'Labels, captions, micro-texto'
  }, {
    token: 'text-sm',
    size: '0.875rem',
    px: '14px',
    weight: '400',
    usage: 'Texto auxiliar, metadados, placeholders'
  }, {
    token: 'text-base',
    size: '1rem',
    px: '16px',
    weight: '400',
    usage: 'Corpo padrão, parágrafos'
  }, {
    token: 'text-lg',
    size: '1.125rem',
    px: '18px',
    weight: '500',
    usage: 'Subtítulos, leads'
  }, {
    token: 'text-xl',
    size: '1.25rem',
    px: '20px',
    weight: '600',
    usage: 'Títulos de seção pequenos'
  }, {
    token: 'text-2xl',
    size: '1.5rem',
    px: '24px',
    weight: '700',
    usage: 'Títulos de card, heading h3'
  }, {
    token: 'text-3xl',
    size: '1.875rem',
    px: '30px',
    ...
    px: '36px',
    weight: '800',
    usage: 'Hero, heading h1'
  }, {
    token: 'text-5xl',
    size: '3rem',
    px: '48px',
    weight: '900',
    usage: 'Display, headlines grandes'
  }, {
    token: 'text-6xl',
    size: '3.75rem',
    px: '60px',
    weight: '900',
    usage: 'Números KPI, métricas destaque'
  }].map(({
    token,
    size,
    px,
  ...
  \`
}`,...(p=(m=n.parameters)==null?void 0:m.docs)==null?void 0:p.source}}};var f,g,c;i.parameters={...i.parameters,docs:{...(f=i.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: () => \`
    <div style="padding: 2rem;">
      <h1 style="color: #10b981; font-size: 2rem; margin-bottom: 0.5rem;">Famílias de Fonte</h1>
      <p style="color: #94a3b8; margin-bottom: 3rem;">Três famílias distintas com papéis claros no sistema.</p>
...
// ✓ 47 posts published today</pre>
  ...
  \`
}`,...(c=(g=i.parameters)==null?void 0:g.docs)==null?void 0:c.source}}};var x,b,v;s.parameters={...s.parameters,docs:{...(x=s.parameters)==null?void 0:x.docs,source:{originalSource:`{
  render: () => \`
    <div style="padding: 2rem;">
      <h1 style="color: #10b981; font-size: 2rem; margin-bottom: 3rem;">Pesos & Estilos</h1>
    ...
    weight: 100,
    label: 'Thin',
    use: 'Decorativo apenas — nunca em corpo'
  }, {
    weight: 300,
    label: 'Light',
    use: 'Subtextos longos, legendas de gráfico'
  }, {
    weight: 400,
    label: 'Regular',
    use: 'Corpo de texto padrão'
  }, {
    weight: 500,
    label: 'Medium',
    use: 'Destaques no corpo, labels de formulário'
  }, {
    weight: 600,
    label: 'SemiBold',
    use: 'Títulos de card, navegação ativa'
  }, {
    weight: 700,
    label: 'Bold',
    use: 'Headings h2-h3, KPIs'
  }, {
    weight: 800,
    label: 'ExtraBold',
    use: 'Títulos de página h1, CTAs'
  }, {
    weight: 900,
    label: 'Black',
    use: 'Display headlines, números mega'
  }].map(({
    weight,
    label,
    use
  ...
  \`
}`,...(v=(b=s.parameters)==null?void 0:b.docs)==null?void 0:v.source}}};var u,h,y;a.parameters={...a.parameters,docs:{...(u=a.parameters)==null?void 0:u.docs,source:{originalSource:`{
  render: () => \`
    <div style="padding: 2rem; max-width: 800px;">
      <h1 style="color: #10b981; font-size: 2rem; margin-bottom: 3rem;">Hierarquia de Headings</h1>
  ...
  \`
}`,...(y=(h=a.parameters)==null?void 0:h.docs)==null?void 0:y.source}}};var z,w,E;d.parameters={...d.parameters,docs:{...(z=d.parameters)==null?void 0:z.docs,source:{originalSource:`{
  render: () => \`
    <div style="padding: 2rem;">
      <h1 style="color: #10b981; font-size: 2rem; margin-bottom: 3rem;">Cores de Texto</h1>
    ...
    color: '#ffffff',
    hex: '#ffffff',
    desc: 'Headings, labels importantes, texto de destaque'
  }, {
    name: 'Secondary',
    color: '#94a3b8',
    hex: '#94a3b8',
    desc: 'Corpo de texto, descrições, parágrafos'
  }, {
    name: 'Muted',
    color: '#64748b',
    hex: '#64748b',
    desc: 'Metadados, timestamps, texto de suporte'
  }, {
    name: 'Disabled',
    color: '#475569',
    hex: '#475569',
    desc: 'Texto de campo desabilitado'
  }, {
    name: 'Emerald',
    color: '#10b981',
    hex: '#10b981',
    desc: 'Links, código inline, valores positivos'
  }, {
    name: 'Success',
    color: '#34d399',
    hex: '#34d399',
    desc: 'Confirmações, status PUBLISHED'
  }, {
    name: 'Warning',
    color: '#fbbf24',
    hex: '#fbbf24',
    desc: 'Avisos, status QUEUED/PROCESSING'
  }, {
    name: 'Error',
    color: '#f87171',
    hex: '#f87171',
    desc: 'Erros, status FAILED'
  }].map(({
    name,
    color,
    hex,
  ...
  \`
}`,...(E=(w=d.parameters)==null?void 0:w.docs)==null?void 0:E.source}}};const D=["EscalaCompleta","FamiliasDeFonte","PesosEEstilos","HierarquiaHeadings","CoresDeTexto"];export{d as CoresDeTexto,n as EscalaCompleta,i as FamiliasDeFonte,a as HierarquiaHeadings,s as PesosEEstilos,D as __namedExportsOrder,S as default};
