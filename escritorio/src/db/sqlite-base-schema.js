...
function ensureSqliteBaseSchema(sqlite) {
  sqlite.exec(`
    ...
    CREATE TABLE IF NOT EXISTS tasks (
      ...
      assigner_npc_id TEXT REFERENCES npcs(id) ON DELETE SET NULL,
    ...
    CREATE INDEX IF NOT EXISTS idx_automation_jobs_status_run_after ON automation_jobs(status, run_after);
    CREATE INDEX IF NOT EXISTS idx_automation_jobs_channel ON automation_jobs(channel_id);
    CREATE INDEX IF NOT EXISTS idx_automation_jobs_npc ON automation_jobs(npc_id);
    CREATE INDEX IF NOT EXISTS idx_automation_jobs_created ON automation_jobs(created_at);
    ...
    CREATE INDEX IF NOT EXISTS idx_approval_requests_channel ON approval_requests(channel_id);
    CREATE INDEX IF NOT EXISTS idx_approval_requests_npc ON approval_requests(npc_id);
    ...
    CREATE INDEX IF NOT EXISTS idx_npc_action_logs_channel_created ON npc_action_logs(channel_id, created_at);
    CREATE INDEX IF NOT EXISTS idx_npc_action_logs_npc_created ON npc_action_logs(npc_id, created_at);
    CREATE INDEX IF NOT EXISTS idx_npc_action_logs_job ON npc_action_logs(job_id);
    CREATE INDEX IF NOT EXISTS idx_npc_action_logs_status ON npc_action_logs(status);
    ...
    CREATE UNIQUE INDEX IF NOT EXISTS office_clients_channel_unique ON office_clients(channel_id);
    CREATE INDEX IF NOT EXISTS idx_office_clients_status ON office_clients(status);
    CREATE INDEX IF NOT EXISTS idx_office_clients_owner ON office_clients(owner_user_id);

    CREATE TABLE IF NOT EXISTS office_memories (
      id TEXT PRIMARY KEY NOT NULL,
      scope TEXT NOT NULL DEFAULT 'client',
      client_id TEXT REFERENCES office_clients(id) ON DELETE CASCADE,
      channel_id TEXT REFERENCES channels(id) ON DELETE CASCADE,
      npc_id TEXT REFERENCES npcs(id) ON DELETE SET NULL,
      memory_type TEXT NOT NULL DEFAULT 'fact',
      title TEXT NOT NULL,
    ...
    CREATE INDEX IF NOT EXISTS idx_office_memories_client ON office_memories(client_id);
    CREATE INDEX IF NOT EXISTS idx_office_memories_channel ON office_memories(channel_id);
    CREATE INDEX IF NOT EXISTS idx_office_memories_npc ON office_memories(npc_id);
    CREATE INDEX IF NOT EXISTS idx_office_memories_importance ON office_memories(importance);
    ...
    CREATE INDEX IF NOT EXISTS idx_office_notifications_status ON office_notifications(status);
    CREATE INDEX IF NOT EXISTS idx_office_notifications_client ON office_notifications(client_id);
    CREATE INDEX IF NOT EXISTS idx_office_notifications_channel ON office_notifications(channel_id);
    CREATE INDEX IF NOT EXISTS idx_office_notifications_created ON office_notifications(created_at);

    CREATE TABLE IF NOT EXISTS office_context_snapshots (
      id TEXT PRIMARY KEY NOT NULL,
      client_id TEXT REFERENCES office_clients(id) ON DELETE CASCADE,
      channel_id TEXT REFERENCES channels(id) ON DELETE CASCADE,
    ...
    CREATE INDEX IF NOT EXISTS idx_office_context_client_kind ON office_context_snapshots(client_id, context_kind);
    CREATE INDEX IF NOT EXISTS idx_office_context_created ON office_context_snapshots(created_at);

    CREATE TABLE IF NOT EXISTS office_agent_runs (
      id TEXT PRIMARY KEY NOT NULL,
      client_id TEXT REFERENCES office_clients(id) ON DELETE CASCADE,
      channel_id TEXT REFERENCES channels(id) ON DELETE CASCADE,
      npc_id TEXT REFERENCES npcs(id) ON DELETE SET NULL,
      ...
      context_snapshot_id TEXT REFERENCES office_context_snapshots(id) ON DELETE SET NULL,
      output TEXT,
      status TEXT NOT NULL DEFAULT 'completed',
      tokens_used INTEGER NOT NULL DEFAULT 0,
      created_at TEXT NOT NULL
    );
    CREATE INDEX IF NOT EXISTS idx_office_agent_runs_client ON office_agent_runs(client_id);
    CREATE INDEX IF NOT EXISTS idx_office_agent_runs_npc ON office_agent_runs(npc_id);
    CREATE INDEX IF NOT EXISTS idx_office_agent_runs_created ON office_agent_runs(created_at);

    CREATE TABLE IF NOT EXISTS telegram_client_groups (
      id TEXT PRIMARY KEY NOT NULL,
      client_id TEXT REFERENCES office_clients(id) ON DELETE SET NULL,
