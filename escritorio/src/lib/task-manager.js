...
// CRUD de tarefas no DB. Recebe db + schema compartilhados do server.js.
...
/** Normaliza linhas camelCase do Drizzle (tratamento de npcName em resultados de JOIN) */
...
class TaskManager {
  ...
  /**
   * Processamento de ações de tarefa (create/update/complete/cancel)
   * Idempotência: upsert em caso de create duplicado, auto-create se o alvo de update/complete não existir.
   */
