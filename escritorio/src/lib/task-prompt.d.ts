...
export declare function buildOfficeCentralProtocol(locale?: string | null): string;
...
export declare function normalizeTaskPromptLocale(locale?: string | null): "en" | "pt";
