...
const ERROR_MESSAGE_KEYS: Record<ErrorCode, string> = {
  ...
  claude_code_not_found: "errors.connectionFailed",
  claude_code_error: "errors.connectionFailed",
  codex_not_found: "errors.connectionFailed",
  codex_login_required: "errors.connectionFailed",
  codex_error: "errors.connectionFailed",
