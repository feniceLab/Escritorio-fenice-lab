      ...
      <div className="fixed inset-0 flex items-start justify-center pt-[15vh] z-20 pointer-events-none">
        <div className="max-w-[360px] w-[90%] pointer-events-auto">
          <div className="text-center mb-4">
            <img src="/logo-fenix-lab-square.png" alt="Fenix Lab" className="mx-auto h-14 w-14 rounded-[var(--radius-md)] bg-white p-2 object-contain shadow-[var(--shadow-brand)]" />
            <h1 className="mt-3 font-display text-3xl font-extrabold text-white">Fenix Lab</h1>
            <p
          ...
          >
                ...
                <button
                  ...
                  className={`flex-1 py-2.5 text-center text-sm font-semibold transition-colors ${
                    mode === "login"
                      ...
                      : "bg-bg text-text-dim hover:text-text-secondary"
                  }`}
                >
                  {t("auth.login")}
                </button>
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              <input
                ...
                className="w-full px-4 py-2.5 bg-bg text-white rounded-[var(--radius-md)] border border-border focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary text-sm placeholder-text-dim"
                minLength={2}
                maxLength={50}
                required
              />
